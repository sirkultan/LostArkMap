    ...
    'initialize': function() {
        ...
        overviewer.coordBoxClass = L.Control.extend({
            ...
            render: function(latlng) {
                var currWorld = overviewer.currentWorld;
                ...
                this.coord_box.innerHTML = "<strong>X</strong> " +
                                           Math.round(latlng.lat * 10) / 10 +
                                           " <strong>Z</strong> " + Math.round(latlng.lng * 10) / 10;
            },
            onAdd: function() {
        ...
        overviewer.control = L.Control.extend({
            ...
            onChange: function(ev) {
                ...
                overviewer.collections.centers[overviewer.currentWorld][0] = overviewer.map.getCenter();
                overviewer.collections.centers[overviewer.currentWorld][1] = overviewer.map.getZoom();
                ...
                overviewer.currentWorld = selected_world;
        ...
        overviewer.map.on('baselayerchange', function(ev) {
            ...
            if (overviewer.currentWorld && overviewer.current_layer[overviewer.currentWorld]) {
                let tsc = overviewer.current_layer[overviewer.currentWorld].tileSetConfig;
            ...
            overviewer.current_layer[overviewer.currentWorld] = ev.layer;
